...
(best (4, 0.03, 5, 0.8, 0.6, 1), cv 0.6556) tuned with 4-fold expanding-window CV inside
...
(LGB, XGB, logistic): [0.56, 0.15, 0.17].

## Model comparison — full test set (1614 fights)

| Predictor | n | Accuracy | Log loss | Brier | ECE |
|---|---|---|---|---|---|
| Stacked ensemble (LGB+XGB+logistic) | 1614 | 0.629 | 0.641 | 0.225 | 0.023 |
| Ensemble + isotonic | 1614 | 0.628 | 0.647 | 0.227 | 0.027 |
| LightGBM | 1614 | 0.628 | 0.643 | 0.225 | 0.031 |
| XGBoost | 1614 | 0.628 | 0.644 | 0.226 | 0.034 |
...
| Stacked ensemble | 1182 | 0.640 | 0.631 | 0.220 | 0.030 |
| Blend: market + model | 1182 | 0.704 | 0.577 | 0.197 | 0.025 | logit blend, model coef=+0.295
